...
<div id="urHere">积云教育 管理中心<b>></b><strong>添加通知</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="{{url('login/select')}}" class="actionBtn">通知列表</a>添加通知</h3>
    <form action="{{url('login/shows')}}" method="post">
      <input type="hidden" name="_token" value="<?php echo csrf_token();?>">
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       <td width="80" align="right">通知标题</td>
       <td>
        <input type="text" name="bt" value="集团通知发布表" size="40" class="inpMain" />
       </td>
      </tr>
