...
@include('mould/left')
   <!-- 当前位置 -->
<div id="urHere">积云教育<b>></b><strong>政策制度管理</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
<div style="font-size:25px;color:red;text-align:center;font-weight:bolder;">
      ...
      @endif
        ...
        <h3><a href="{{url('zhengceinsert')}}" class="actionBtn add">添加政策</a>政策制度管理</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     ...
     <tr>
      ...
      <th align="center" width="80">政策制度标题</th>
        <th align="center" width="80">政策制度副标题</th>
        <th width="80" align="center">政策制度内容</th>
      ...
      @foreach($data as $v)
        ...
        <td align="center">{{$v->zc_bt}}</td>
        <td  align="center">{{$v->zc_fbt}}</td>
        <td align="center">{{mb_substr($v->zc_text,1,100)}}</td>
        <td align="center">{{$v->username}}</td>
        <td align="center">{{$v->zc_date}}</td>
        <td align="center">
        <a href="zhengceupdate?id={{$v->id}}">编辑</a> | <a href="zhengcedel?id={{$v->id}}">删除</a></td>
      </tr>
      @endforeach
...
//                alert(length);
                ...
                str= str.substr(1);
//                alert(str)
                location.href="zhengcedeletes?id="+str;
            })
          })
</script>