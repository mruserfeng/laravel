...
@include('mould/left')
   <!-- 当前位置 -->
<div id="urHere">积云教育<b>></b><strong>意向学生</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
<div style="font-size:25px;color:red;text-align:center;font-weight:bolder;">
      ...
      @endif
        ...
        <h3><a href="{{url('studentinsert')}}" class="actionBtn add">添加学生</a>意向学生</h3>
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     ...
     <tr>
      ...
      <th align="center" width="80">姓名</th>
        ...
        <th align="center" width="80">学历</th>
      ...
      @foreach($data as $v)
        ...
        <td align="center">@if($v->education==1)小学@elseif($v->education==2)初中@elseif($v->education==3)高中@elseif($v->education==4)大学@else其他@endif</td>
        <td align="center">{{$v->tel}}</td>
        <td align="center">@if($v->sex==1)男 @else 女 @endif</td>
        <td align="center">{{$v->date}}</td>
        <td align="center">
        <a href="studenteupdate?id={{$v->id}}">编辑</a> | <a href="studentdel?id={{$v->id}}">删除</a></td>
      </tr>
      @endforeach
      <tr><td id="pull_right"colspan="8">{{$data->render()}}</td></tr>
          </table>
           </div>
 </div>
@include('mould/tail')
...
//                alert(length);
                ...
                str= str.substr(1);
//                alert(str)
                location.href="studentdeletes?id="+str;
            })
          })
</script>