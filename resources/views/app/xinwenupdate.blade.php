...
@include('mould/left')
   <!-- 当前位置 -->
<div id="urHere">积云教育<b>></b><strong>修改新闻</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="article_category.html" class="actionBtn">新闻管理</a>修改新闻</h3>
    <form action="{{url('xinwenupdate')}}" method="post" enctype="multipart/form-data">
   ...
   <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
     ...
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" name="jouli_bt" value="{{$data->jouli_bt}}" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="right">新闻副标题</td>
       <td>
        <input type="text" name="jouli_fbt" value="{{$data->jouli_fbt}}" size="40" class="inpMain" />
       </td>
         <tr>
      ...
      <script charset="utf-8" src="{{asset('app')}}/js/kindeditor/plugins/code/prettify.js"></script>
        <script>
          KindEditor.ready(function(K) {
            var editor1 = K.create('textarea[name="jouli_text"]', {
        ...
        <!-- /KindEditor -->
        <textarea id="content" name="jouli_text" style="width:780px;height:400px;" class="textArea"> {{$data->jouli_text}}</textarea>
       </td>
      <tr>
       <td></td>
       <td>
