...
@include('mould/left')
   <!-- 当前位置 -->
<div id="urHere">积云教育<b>></b><strong>修改政策</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
            <h3><a href="article_category.html" class="actionBtn">政策管理</a>修改政策</h3>
    <form action="{{url('zhengceupdate')}}" method="post">
   ...
   <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
     ...
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" name="zc_bt" value="{{$data->zc_bt}}" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
       <td align="right">新闻副标题</td>
       <td>
        <input type="text" name="zc_fbt" value="{{$data->zc_fbt}}" size="40" class="inpMain" />
       </td>
         <tr>
      ...
      <script charset="utf-8" src="{{asset('app')}}/js/kindeditor/plugins/code/prettify.js"></script>
        ...
        <!-- /KindEditor -->
        <textarea id="content" name="zc_text" style="width:780px;height:400px;" class="textArea">{{$data->zc_text}}</textarea>
       </td>
      <tr>
       <td></td>
       <td>
