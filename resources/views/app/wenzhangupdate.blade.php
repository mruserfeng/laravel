...
<div id="urHere">积云教育<b>></b><strong>添加文章</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    ...
    <form action="{{url('wenzhangupdate')}}" method="post" enctype="multipart/form-data">
   ...
   <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
     ...
     <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
      <tr>
       ...
       <td>
        <input type="text" name="text_name" value="{{$data->text_name}}" size="40" class="inpMain" />
       </td>
      </tr>
      <tr>
      ...
      <script charset="utf-8" src="{{asset('app')}}/js/kindeditor/plugins/code/prettify.js"></script>
        ...
        <!-- /KindEditor -->
        <textarea id="content" name="release_text" style="width:780px;height:400px;" class="textArea">{{$data->release_text}}</textarea>
       </td>
      </tr>
